...
[Usage]
python model/tf2_encoder_checkpoint_converter.py --bert_config_file pre_bert/biobert_v1.1_pubmed/bert_config.json --checkpoint_to_convert pre_bert/biobert_v1.1_pubmed/model.ckpt-1000000 --converted_checkpoint_path pre_bert/biobert_tf2
"""
